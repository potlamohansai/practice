...
//function that takes in a number as a string n and returns the number without trailing and leading zeros

function removeLeadingTrailing(str) {
    let regex = /([1-9][0-9]+[.][0-9]+[1-9]+)|([1-9][0-9]+[.][1-9]+)|([1-9][0-9]+)/g
